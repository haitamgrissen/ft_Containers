...
namespace ft
{
    ...
    class vector
    {
        ...
        public :
            ...
            const allocator_type& alloc = allocator_type(), typename enable_if<!is_integral<InputIterator>::value,InputIterator >::type = InputIterator()) : m_alloc(alloc),m_data(nullptr), m_size(0), m_capacity(0)
            {
                size_t i = 0;
